...
const makePostgresRepository = function (name) {
    ...
    export abstract class PostgresRepository<T extends BaseModel> extends BaseRepository<T> {
...
module.exports = makePostgresRepository;
